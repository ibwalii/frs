        ...
        <div class="grids-area-hny main-cont-wthree-fea row mt-5 pt-lg-5 pt-5">
          ...
          <div class="col-lg-4 col-md-6 grids-feature mt-md-0 mt-4">
            <div class="area-box">
              ...
              <p>Vivamus a ligula quam tesque et libero ut justo, ultrices in. Ut eu leo non. Duis sed dolor et amet.
              </p>
            </div>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-lg-6 mt-lg-0 mt-5 align-self">
              ...
              <ul class="w3l-right-book mt-lg-5 mt-4">
                <li><span class="fa fa-check" aria-hidden="true"></span>Help sellers get the most for their properties
                </li>
                <li><span class="fa fa-check" aria-hidden="true"></span>Help sellers price their properties fairly</li>
                <li><span class="fa fa-check" aria-hidden="true"></span>Help buyers find the property that fits their
                  needs</li>
                <li><span class="fa fa-check" aria-hidden="true"></span>Avoid over paying by strategically negotiating
                  purchase</li>
              </ul>
            </div>
          </div>
