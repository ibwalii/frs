  ...
  <body class="app sidebar-mini">
    ...
    <div class="app-sidebar__user"><img class="app-sidebar__user-avatar" src="../assets/images/mole.png" alt="User Image">
      ...
      <ul class="app-menu">
        ...
        <li class="treeview is-expanded"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-laptop"></i><span class="app-menu__label">User Management</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
            <li><a class="treeview-item" href="page-user.php"><i class="icon fa fa-circle-o"></i> New User</a></li>
            <li><a class="treeview-item active" href="page-users-list.php"><i class="icon fa fa-circle-o"></i> Users List</a></li>
          </ul>
        </li>
