...
<?php
    ...
    $report_sql = "SELECT * FROM reports where r_status = 0 order by r_id desc";
    $report_result = mysqli_query($conn, $report_sql);
    $report_row = mysqli_fetch_assoc($report_result);
    $rows = mysqli_num_rows($report_result);
...
<html lang="en">
  <head>
    <meta name="description" content="Police FRS is a responsive and free admin theme built with Bootstrap 4, SASS and PUG.js. It's fully customizable and modular.">
    <!-- Twitter meta-->
    ...
    <meta property="og:title" content="Police FRS - Free Bootstrap 4 admin theme">
    ...
    <meta property="og:description" content="Police FRS is a responsive and free admin theme built with Bootstrap 4, SASS and PUG.js. It's fully customizable and modular.">
    <title>Blank Page - Police FRS Admin</title>
    <meta charset="utf-8">
  ...
  <body class="app sidebar-mini">
    <!-- Navbar-->
    <header class="app-header"><a class="app-header__logo" href="index.html">Police FRS</a>
      ...
      <ul class="app-menu">
        ...
        <li class="treeview is-expanded"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-laptop"></i><span class="app-menu__label">Fraud Reports</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
            ...
            <li><a class="treeview-item active" href="page-reports-unconfirmed.php"><i class="icon fa fa-circle-o"></i> Unconfirmed Reports</a></li>
    ...
    <main class="app-content">
      <div class="app-title">
        ...
        <ul class="app-breadcrumb breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="#">Unverified</a></li>
        </ul>
      </div>
      <div class="row">
        <div class="col-md-12">
              ...
              <div class="table-responsive">
                <table class="table table-hover table-bordered" id="sampleTable">
                  ...
                  ?>
                    <tr>
                      <td>
                        <?php if(isset($report_row['r_title']) && !empty($report_row['r_title'])) { echo $report_row['r_title']; }else{ echo "Not Assigned"; } ?>
                      </td>
                      <td>
                        <?php if(isset($report_row['r_cat']) && !empty($report_row['r_cat'])) { echo $report_row['r_cat']; }else{ echo "Not Assigned"; } ?>
                      </td>
                      <td>
                        <?php if(isset($report_row['r_payment']) && !empty($report_row['r_payment'])) { echo $report_row['r_payment']; }else{ echo "Not Assigned"; } ?>
                      </td>
                      <td><?php if(isset($report_row['r_amount']) && !empty($report_row['r_amount'])) { echo $report_row['r_amount']; }else{ echo "Not Assigned"; } ?></td>
                      <td>
                        <?php if(isset($report_row['r_date']) && !empty($report_row['r_date'])) { echo $report_row['r_date']; }else{ echo "Not Assigned"; } ?>
                      </td>
                      <td>
                        <?php
                         
                           $report_comments_sql = "SELECT * FROM reports_comments where r_id = {$report_row['r_id']}";
                        ...
                        ?>
                        <a href="page-report.php?r_id=<?php echo $report_row['r_id']; ?>"><?php echo $report_comments_rows;  ?></a>
                      </td>
                      <td>
                        <a href="page-report.php?r_id=<?php echo $report_row['r_id']; ?>">
